...
func main() {
	...
	// waits (import --follow, add --wait) stops cleanly, and cli.Run exits
	// 130 without an error message. After the first signal the default
	// handling is back, and a second one kills.
